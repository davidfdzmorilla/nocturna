...
3. **DDD**: `domain/` sin imports de infraestructura; casos de uso en `application/`; ORM no se filtra hacia arriba. ¿Hay abstracción sin uso en fase 1? Eso es sobrearquitectura: se señala.

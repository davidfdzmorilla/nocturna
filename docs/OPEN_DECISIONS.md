...
- [ ] T10/T11 · Repositorios síncronos conviviendo con `LLMProvider` async · opciones vistas: mantener la mezcla (SQLAlchemy sync es lo instalado, el pipeline es batch monohilo); unificar
